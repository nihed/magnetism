...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\firefoxjournal on
     Windows, /home/user/dev/firefoxjournal on Linux) in a file named
     firefoxjournal@colin.walters and copy that file to
