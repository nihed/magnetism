...
<dht3:page>
	<dht3:shinyBox color="grey">
		...
		<dht3:stackerLearnMore>
			...
			<div class="dh-download-section-description"><p>After the <a class="dh-underlined-link" href="/download">Mugshot download</a> is installed, an icon
		...
		<div>Learn more about: <a class="dh-underlined-link" href="webswarm-learnmore">Web Swarm</a> | <a class="dh-underlined-link" href="radar-learnmore">Music Radar</a></div>
	</dht3:shinyBox>
</dht3:page>
