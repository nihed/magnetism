	...
	<dht3:pageSubHeader title="${person.viewedPerson.name}'s ${pageName}">
		<dht3:randomTip tipIndex="${person.randomTipIndex}" isSelf="${person.self}"/>
			...
			<c:when test="${!signin.user.account.disabled}">
			    ...
			    <div class="dh-page-shinybox-subtitle"><span class="dh-download-product">Get maximum Mugshot!</span> <a class="dh-underlined-link" href="/download">Download the Mugshot Client</a> to use all of our features.  It's easy and free!</div>
				...
				<dht:formTableRow label="Accounts" altRow="true">
				    ...
				    <dht:formTableRow label="AIM" icon="/images3/${buildStamp}/aim_icon.png" info="Only your Mugshot friends see this.">
					    ...
					    <div>
						    <a href="${account.addAimLink}"><dh:png klass="dh-add-icon" src="/images3/${buildStamp}/add_icon.png" style="width: 8; height: 8; overflow: hidden;"/>IM our friendly bot to add a new screen name</a>
					    </div>
				    </dht:formTableRow>				
