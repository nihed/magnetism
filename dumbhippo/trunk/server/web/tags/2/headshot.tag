...
<a href="/person?who=${person.user.id}" style="text-decoration: none;"><dh:png src="/files/headshots/${size}/${person.user.id}?v=${person.user.version}" style="width: ${size}; height: ${size};"/></a>
</c:if>
