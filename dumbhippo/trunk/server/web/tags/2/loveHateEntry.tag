...
<div id="${baseId}AllId" class="dh-love-hate">
	...
	<div id="${baseId}IndifferentInfoId" style="display: none;">
		<dht:loveHateEntryDescription isEditing="false" baseId="${baseId}" name="${name}" userInfoType="${userInfoType}" link="${link}"/>		
	</div>
	<div id="${baseId}LoveEditId" style="display: none;">
		...
		<dht:loveHateEntryDescription isEditing="true" baseId="${baseId}" name="${name}" userInfoType="${userInfoType}" link="${link}"/>
	</div>	
