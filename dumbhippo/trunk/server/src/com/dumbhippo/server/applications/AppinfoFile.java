...
public class AppinfoFile extends JarFile {
	...
	static final private String SOURCE_ELEMENT = "[A-Za-z0-9+-]+";
	static final private String PACKAGE_NAME = "[A-Za-z0-9+_.-]+";
	static final private String SOURCE_LIST = "(" + SOURCE_ELEMENT + "\\s*,\\s*)*" + SOURCE_ELEMENT;
	static final private String PACKAGE_ELEMENT = SOURCE_LIST + "\\s*=\\s*" + PACKAGE_NAME;
	static final private String PACKAGE_LIST = "(" + PACKAGE_ELEMENT + "\\s*;\\s*)*" + PACKAGE_ELEMENT;
	
	static final private Pattern PACKAGE_REGEX = Pattern.compile(PACKAGE_NAME);
	static final private Pattern PACKAGE_NAMES_REGEX = Pattern.compile("|" + PACKAGE_LIST);
	...
	private void readProperties() throws ValidationException, IOException {
		...
		packageNames = getStringProperty("packagenames", PACKAGE_NAMES_REGEX, true);
		
		// Support "package=<fedora package>"for migration of old .dappinfo
		// files generated by the first version of rpm2dappinfo.
		if (packageNames == null) {
			String packageName = getStringProperty("package", PACKAGE_REGEX, true);
			if (packageName != null) {
				packageNames = "fedora=" + packageName;
			}
		}
