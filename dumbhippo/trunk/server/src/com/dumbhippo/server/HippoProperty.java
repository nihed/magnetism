...
public enum HippoProperty {
	...
	DOWNLOADINFO_WINDOWS_CURRENT("dumbhippo.server.downloadinfo.windows.current", null),
	DOWNLOADINFO_WINDOWS_DATE("dumbhippo.server.downloadinfo.windows.date", null),	
	DOWNLOADINFO_LINUX_CURRENT("dumbhippo.server.downloadinfo.linux.current", null),
	DOWNLOADINFO_LINUX_DATE("dumbhippo.server.downloadinfo.linux.date", null),
