 ...
 */
public abstract class BaseTransport implements Component, RosterEventListener, UserEventListener {
...
//            xEvent.addElement("id");
    ...
    public void userDeleting(User user, Map<String,Object> params) {
        try {
            deleteRegistration(new JID(user.getUsername(), XMPPServer.getInstance().getServerInfo().getName(), null));
        }
        catch (UserNotFoundException e) {
