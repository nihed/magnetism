...
// New stuff should use ApplicationDMO and ApplicationsIQHandler, not this LegacyApplicationsIQHandler
@IQHandler(namespace=LegacyApplicationsIQHandler.APPLICATIONS_NAMESPACE)
public class LegacyApplicationsIQHandler extends AnnotatedIQHandler  implements LiveEventListener<UserPrefChangedEvent> {
	...
	public LegacyApplicationsIQHandler() {
		super("Hippo application usage IQ Handler (deprecated version)");
	}
	...
	/**
	 * Do not use this; there are properties on UserDMO for topApplications, since, and enabled
	 * 
	 * @param viewpoint
	 * @param request
	 * @param reply
	...
	/**
	 * Do not use this; there is a property for it on UserDMO
	 * 
	 * @param viewpoint
	 * @param request
	 * @param reply
