                          ...
                          HippoPost      *post)
{
     ...
     * Note this creates the guarantee that all posts have a chat room != NULL
     * from the start, which some code may well rely on.
     */
                      ...
                      void          *data)
{
    ...
    hippo_chat_room_set_user_state(room, cache->cached_self, HIPPO_CHAT_NONMEMBER);
