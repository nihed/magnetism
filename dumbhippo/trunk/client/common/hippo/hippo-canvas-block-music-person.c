...
static void
on_FIXME_changed(HippoBlock *block,
                                          ...
                                          HippoBlock       *block)
{
    ...
    if (canvas_block->block != NULL) {
        ...
        on_FIXME_changed(canvas_block->block, NULL, canvas_block);
    }
}
...
hippo_canvas_block_music_person_title_activated(HippoCanvasBlock *canvas_block)
{
    ...
    return; /* FIXME we need the music person block */
