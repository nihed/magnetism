...
#
# This is JUST A COPY of the OverviewLayout from BigBoard. Any bug fixes should
# go there. If you want the latest version of the code, get it from there. It's
# only cut-and-pasted to here to get a stand-alone test of the HippoCanvasLayout
# functionality.
#
# NB NB NB NB NB NB NB NB NB
