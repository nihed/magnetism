...
public class MSNListener extends MsnAdapter {
    ...
    public void exceptionCaught(MsnMessenger messenger, Throwable throwable) {
        ...
        if (throwable.getClass().getName().equals("net.sf.jml.exception.IncorrectPasswordException")) {
            ...
            msnSession.sessionDisconnectedNoReconnect(LocaleUtils.getLocalizedString("gateway.msn.passwordincorrect", "gateway"));
        }
            ...
            msnSession.setLoginStatus(TransportLoginStatus.DISCONNECTED);
            msnSession.sessionDisconnected(LocaleUtils.getLocalizedString("gateway.msn.disconnect", "gateway"));
        }
        else {
