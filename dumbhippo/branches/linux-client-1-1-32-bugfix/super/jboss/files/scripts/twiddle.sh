...
# HIPPO: Set JBOSS_HOME to allow running not from /opt/jboss
JBOSS_HOME=@@jbossdir@@
...
if [ "x$JBOSS_CLASSPATH" = "x" ]; then
    # HIPPO: Include the directory from where twiddle.sh is run so we can find jnp.properties
    JBOSS_CLASSPATH="$DIRNAME:$JBOSS_BOOT_CLASSPATH"
