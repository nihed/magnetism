...
<dht3:page currentPageLink="google-stacker">
	<dht3:shinyBox color="grey">
		...
		<div>
			<center>
				<script src="http://gmodules.com/ig/ifr?url=${dh:urlEncode(baseUrl)}/google-stacker-spec&amp;synd=open&amp;w=320&amp;h=250&amp;title=Mugshot+Stacker&amp;border=%23ffffff%7C3px%2C1px+solid+%23999999&amp;output=js">
				</script>
			</center>
		</div>
		<div>
		...
		<div>
			Or, <a href="http://gmodules.com/ig/creator?synd=open&url=${dh:urlEncode(baseUrl)}/google-stacker-spec">get the code</a> to put this 
