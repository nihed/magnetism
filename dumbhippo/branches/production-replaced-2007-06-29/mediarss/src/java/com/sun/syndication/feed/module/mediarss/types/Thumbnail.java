...
public class Thumbnail implements Cloneable {
     ...
     */
    public Thumbnail(URL url, Integer width, Integer height, Time time) {
        this.thumbUrl = url;
     ...
     * @param height height
     */
    public Thumbnail(URL url, Integer width, Integer height) {
